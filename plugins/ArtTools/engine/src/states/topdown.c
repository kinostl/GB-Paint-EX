    ...
    if ((topdown_grid == 16 && ON_16PX_GRID(PLAYER.pos)) ||
        ...
        if (INPUT_RECENT_LEFT) {
            ...
            while (tile_start != tile_end) {
                if (win_down_and_tile_at(tile_x - 1, tile_start) & COLLISION_RIGHT) {
                    player_moving = FALSE;
                    break;
                }
                tile_start++;
            ...
            while (tile_start != tile_end) {
                if (win_down_and_tile_at(tile_x + 1, tile_start) & COLLISION_LEFT) {
                    player_moving = FALSE;
                    break;
                }
                tile_start++;
            ...
            while (tile_start != tile_end) {
                if (win_down_and_tile_at(tile_start, tile_y - 1) & COLLISION_BOTTOM) {
                    player_moving = FALSE;
                    break;
                }
                tile_start++;
            ...
            while (tile_start != tile_end) {
                if (win_down_and_tile_at(tile_start, tile_y + 1) & COLLISION_TOP) {
                    player_moving = FALSE;
                    break;
                }
                tile_start++;
